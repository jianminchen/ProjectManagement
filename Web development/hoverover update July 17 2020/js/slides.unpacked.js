...
(function (a) {
    a.fn.slides = function (b) {
        ...
        this.each(function () {
            ...
            // Need to work on this left setting - 4/27/2017, issues on mobile vertical/ horizontal
            d.children().css({
                position: "absolute",
                top: 0,
            ...
            d.children().each(function (index, value) {
                // maintenance log
                // Sept. 30, 2019 - add MP, WN, TK
                // Dec. 7, 2017 - add WO
                // Nov. 28, 2017 - add MSC
                // April 8, 2016 - April 15, 2016; add ABS on January 4, 2016; 
                // add PS6 on Sept 7, 2017
                var finishArray = ["MA", "BK", "BA", "BZ", "BZP", "S6", "BT0", "WH", "PB", "AB", "ABZ", "PS6", "SI", "MSC", "WO","WN","TK","MP", "CO","ML","CD"];
                var key = "any_" + m ;
            ...
            a("." + b.paginationClass + " li a", c).click(function () {
                ...
                var slidesPageID = a(this).attr("id");
                
                var finishFullCss = slidesPageID.replace("slidesPageID_finish_", ".finish_full."); //  Nov. 3, 2017 
